    ...
    <section className="w-full flex items-center justify-center ">
      <div className="w-[90%] md:w-9/12 mt-32 lg:mt-40 mb-10 lg:mb-10 ">
        ...
        <div className="w-full flex justify-center">
          <div className="w-full md:w-1/2 bg-white p-4 md:p-8 rounded-xl shadow-md">
            <h2 className="text-center text-2xl font-bold mb-6 text-gray-900">Support Request Form</h2>

            <form className="flex flex-col gap-4">
              <div className="flex flex-col md:flex-row gap-4">
                <input type="text" placeholder="Full Name" className="flex-1 border p-2 rounded" />
                <input type="text" placeholder="Business Name" className="flex-1 border p-2 rounded" />
              </div>

              <div className="flex flex-col md:flex-row gap-4">
                <input type="email" placeholder="Email Address" className="flex-1 border p-2 rounded" />
                <input type="text" placeholder="Phone Number (optional)" className="flex-1 border  p-2 rounded" />
              </div>
